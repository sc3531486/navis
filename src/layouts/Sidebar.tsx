...
import { SidebarWorktreeTitle } from '../components/Sidebar/SidebarWorktreeTitle';
import { closeMenu, getMenuItems, isMenuOpen, openMenu, toggleMenu, type MenuActionItem } from '../stores/menu';
import { executeSessionMenuItem, getSessionMenuItems, getSessionSubmenuItems } from '../stores/session-menu';
import { executeWorktreeMenuItem } from '../stores/worktree-menu';
import { setPendingStartKind } from '../stores/app';
import { openSettingsDialog } from '../components/Settings/openSettingsDialog';
import { languageState, loadLanguage } from '../stores/language';
import {
  executeGatewayMenuItem,
  gatewayMenuSelectedCommands,
  gatewayMenuSubmenuItems,
} from '../stores/gateway-menu';
import { selectSessionWithEditorGuard } from '../stores/editor-context-transition';
import {
  activateSession,
  activeSession,
  loadSessionTree,
...
import { SidebarGatewayMenu } from '../components/Sidebar/SidebarGatewayMenu';
import { SidebarModeMenu } from '../components/Sidebar/SidebarModeMenu';
import { SidebarModeTabs } from '../components/Sidebar/SidebarModeTabs';
import { SidebarSessionRow } from '../components/Sidebar/SidebarSessionRow';
import {
  MODE_MENU,
...
import gatewayIconUrl from '../assets/navis-product-icon.svg';
import gatewayChevronUrl from '../assets/gateway-v.svg';
import projectFolderCloseUrl from '../assets/project-folder-close.svg';
import projectFolderOpenUrl from '../assets/project-folder-open.svg';
import projectEditUrl from '../assets/project-edit.svg';
import menuIconUrl from '../assets/menu.svg';
import runningIconUrl from '../assets/RUNNING.svg';
import completedTaskIconUrl from '../assets/task-completed-dot.svg';
