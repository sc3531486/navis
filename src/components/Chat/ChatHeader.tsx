...
import { RightWorkspaceHeader } from '../RightWorkspaceHeader';
import { ScreenIcon } from '../Icon';
import { closeMenu, getMenuItems, isMenuOpen, toggleMenu, type MenuActionItem } from '../../stores/menu';
import { executeSessionMenuItem, getSessionSubmenuItems } from '../../stores/session-menu';
import { activeSession, activeSessionId } from '../../stores/session-tree';
import { loadEditorSettings, settingsState } from '../../stores/settings';
