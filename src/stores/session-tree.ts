...
import { appState, setActiveSession as setAppActiveSession, setPendingStartKind } from './app';
import { gatewayState, loadGatewayCatalog, preferredGatewayDefaultModelSelection, type GatewayModelSelection } from './gateway';
...
function applySessionTree(tree: UiSessionTree): void {
  ...
  setAppActiveSession(tree.activeSessionId);
}
