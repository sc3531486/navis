...
import { AgentTimelineView } from '@agent-core/components/AgentTimeline/AgentTimelineView';
import MessageContentRenderer from '@agent-core/components/ui/MessageContentRenderer';
...
import type { TaskProjection } from '@task-ext/stores/task-projection';
