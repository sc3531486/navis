...
import type { Command } from '@navis-code/components/CommandPalette/store';
import CloseIcon from '@/components/Icon/CloseIcon';
import { FolderIcon, SendIcon, StopIcon } from '@navis-code/components/Icon';
import { SlashCommandDropdown } from '@navis-code/components/SlashCommandDropdown';
