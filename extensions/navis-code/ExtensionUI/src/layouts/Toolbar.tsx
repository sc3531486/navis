...
import { hostState, toggleSidebar } from '@/stores/host';
import { commandPaletteAPI } from '@navis-code/components/CommandPalette';
import { globalSearchAPI } from '@editor-ext/components/GlobalSearchPalette';
import { useHotkeyCommand } from '@/lib/hotkey';
import { navigateToView } from '@/stores/view-navigation';
...
import { executeToolsMenuItem } from '@project-ext/stores/tools-menu';
