 ...
 * import type { Command, CommandSource, CommandScope } from '@navis-code/components/CommandPalette'
 *
 * // 导入 Hook（自定义命令面板 UI 时使用）
 * import { useCommandPalette } from '@navis-code/components/CommandPalette'
 * ```
 */
